...
namespace YooAsset
{
    internal abstract class ProviderOperation : AsyncOperationBase
    {
        ...
        ///     获取的场景对象
        /// </summary>
        public Scene SceneObject { protected set; get; }
        ...
        protected void ProcessFatalEvent()
        {
            ...
            var error =
                $"The bundle {LoadBundleFileOp.BundleFileInfo.Bundle.BundleName} has been destroyed by unity bugs !";
        ...
        public void InitSpawnDebugInfo()
        {
            ...
            ;
            SpawnTime = SpawnTimeToString(Time.realtimeSinceStartup);
        }

        private string SpawnTimeToString(float spawnTime)
        {
            float h = Mathf.FloorToInt(spawnTime / 3600f);
            float m = Mathf.FloorToInt(spawnTime / 60f - h * 60f);
            float s = Mathf.FloorToInt(spawnTime - m * 60f - h * 3600f);
        ...
        {
            if (_watch == null) _watch = Stopwatch.StartNew();
        }
