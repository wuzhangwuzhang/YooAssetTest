...
namespace YooAsset
{
    internal sealed class BundledAssetProvider : ProviderOperation
    {
        ...
        public BundledAssetProvider(ResourceManager manager, string providerGUID, AssetInfo assetInfo) : base(manager,
        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.Checking)
            {
                ...
                if (AssetObject == null)
                {
                    ...
                    if (MainAssetInfo.AssetType == null)
                        error =
                            $"Failed to load asset : {MainAssetInfo.AssetPath} AssetType : null AssetBundle : {LoadBundleFileOp.BundleFileInfo.Bundle.BundleName}";
                    else
                        error =
                            $"Failed to load asset : {MainAssetInfo.AssetPath} AssetType : {MainAssetInfo.AssetType} AssetBundle : {LoadBundleFileOp.BundleFileInfo.Bundle.BundleName}";
