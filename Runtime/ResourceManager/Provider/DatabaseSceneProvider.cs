...
namespace YooAsset
{
    internal sealed class DatabaseSceneProvider : ProviderOperation
    {
        ...
        public DatabaseSceneProvider(ResourceManager manager, string providerGUID, AssetInfo assetInfo,
            LoadSceneParameters loadSceneParams, bool suspendLoad) : base(manager, providerGUID, assetInfo)
        {
        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.Loading)
            {
                ...
                {
                    SceneObject = EditorSceneManager.LoadSceneInPlayMode(MainAssetInfo.AssetPath, LoadSceneParams);
                    _steps = ESteps.Checking;
                }
                else
                {
                    _asyncOperation =
                        EditorSceneManager.LoadSceneAsyncInPlayMode(MainAssetInfo.AssetPath, LoadSceneParams);
        ...
        {
            if (IsDone == false) _suspendLoadMode = false;
        }
    }
}