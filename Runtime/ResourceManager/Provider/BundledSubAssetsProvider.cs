...
namespace YooAsset
{
    internal sealed class BundledSubAssetsProvider : ProviderOperation
    {
        ...
        public BundledSubAssetsProvider(ResourceManager manager, string providerGUID, AssetInfo assetInfo) : base(
        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.None) _steps = ESteps.CheckBundle;
            ...
            if (_steps == ESteps.Loading)
            {
                if (IsWaitForAsyncComplete)
                {
                    if (MainAssetInfo.AssetType == null)
                        ...
                        AllAssetObjects =
                            _assetBundle.LoadAssetWithSubAssets(MainAssetInfo.AssetPath, MainAssetInfo.AssetType);
                }
                else
                {
                    if (MainAssetInfo.AssetType == null)
                        ...
                        _cacheRequest =
                            _assetBundle.LoadAssetWithSubAssetsAsync(MainAssetInfo.AssetPath, MainAssetInfo.AssetType);
                }
            ...
            if (_steps == ESteps.Checking)
            {
                ...
                if (AllAssetObjects == null)
                {
                    ...
                    if (MainAssetInfo.AssetType == null)
                        error =
                            $"Failed to load sub assets : {MainAssetInfo.AssetPath} AssetType : null AssetBundle : {LoadBundleFileOp.BundleFileInfo.Bundle.BundleName}";
                    else
                        error =
                            $"Failed to load sub assets : {MainAssetInfo.AssetPath} AssetType : {MainAssetInfo.AssetType} AssetBundle : {LoadBundleFileOp.BundleFileInfo.Bundle.BundleName}";
