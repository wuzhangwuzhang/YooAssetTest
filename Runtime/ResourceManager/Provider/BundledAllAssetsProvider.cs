...
namespace YooAsset
{
    internal sealed class BundledAllAssetsProvider : ProviderOperation
    {
        ...
        public BundledAllAssetsProvider(ResourceManager manager, string providerGUID, AssetInfo assetInfo) : base(
        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.Checking)
            {
                ...
                if (AllAssetObjects == null)
                {
                    ...
                    if (MainAssetInfo.AssetType == null)
                        error =
                            $"Failed to load all assets : {MainAssetInfo.AssetPath} AssetType : null AssetBundle : {LoadBundleFileOp.BundleFileInfo.Bundle.BundleName}";
                    else
                        error =
                            $"Failed to load all assets : {MainAssetInfo.AssetPath} AssetType : {MainAssetInfo.AssetType} AssetBundle : {LoadBundleFileOp.BundleFileInfo.Bundle.BundleName}";
