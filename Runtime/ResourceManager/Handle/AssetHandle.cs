...
namespace YooAsset
{
    public sealed class AssetHandle : HandleBase, IDisposable
    {
        ...
        private GameObject InstantiateSyncInternal(bool setPositionAndRotation, Vector3 position, Quaternion rotation,
            Transform parent, bool worldPositionStays)
        {
            ...
            return InstantiateOperation.InstantiateInternal(Provider.AssetObject, setPositionAndRotation, position,
                rotation, parent, worldPositionStays);
        }

        private InstantiateOperation InstantiateAsyncInternal(bool setPositionAndRotation, Vector3 position,
            Quaternion rotation, Transform parent, bool worldPositionStays)
        {
            var packageName = GetAssetInfo().PackageName;
            var operation = new InstantiateOperation(this, setPositionAndRotation, position, rotation, parent,
                worldPositionStays);
