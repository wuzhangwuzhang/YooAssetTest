...
namespace YooAsset
{
    internal class PlayModeHelper
    {
        public static IFileSystem CreateFileSystem(string packageName, FileSystemParameters parameters)
        {
            ...
            foreach (var param in parameters.CreateParameters) instance.SetParameter(param.Key, param.Value);
            instance.OnCreate(packageName, parameters.RootDirectory);
            return instance;
        }

        public static List<BundleInfo> GetDownloadListByAll(PackageManifest manifest, IFileSystem fileSystemA = null,
            IFileSystem fileSystemB = null, IFileSystem fileSystemC = null)
        {
        ...
        public static List<BundleInfo> GetDownloadListByTags(PackageManifest manifest, string[] tags,
            IFileSystem fileSystemA = null, IFileSystem fileSystemB = null, IFileSystem fileSystemC = null)
        {
            var result = new List<BundleInfo>(1000);
            foreach (var packageBundle in manifest.BundleList)
            {
        ...
        public static List<BundleInfo> GetDownloadListByPaths(PackageManifest manifest, AssetInfo[] assetInfos,
            IFileSystem fileSystemA = null, IFileSystem fileSystemB = null, IFileSystem fileSystemC = null)
        {
            // 获取资源对象的资源包和所有依赖资源包
        ...
        public static List<BundleInfo> GetUnpackListByAll(PackageManifest manifest, IFileSystem fileSystemA = null,
            IFileSystem fileSystemB = null, IFileSystem fileSystemC = null)
        {
            var result = new List<BundleInfo>(1000);
            foreach (var packageBundle in manifest.BundleList)
        ...
        public static List<BundleInfo> GetUnpackListByTags(PackageManifest manifest, string[] tags,
            IFileSystem fileSystemA = null, IFileSystem fileSystemB = null, IFileSystem fileSystemC = null)
        {
            var result = new List<BundleInfo>(1000);
            foreach (var packageBundle in manifest.BundleList)
        ...
        public static List<BundleInfo> GetImporterListByFilePaths(PackageManifest manifest, string[] filePaths,
            IFileSystem fileSystemA = null, IFileSystem fileSystemB = null, IFileSystem fileSystemC = null)
        {
