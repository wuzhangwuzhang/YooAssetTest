...
namespace YooAsset
{
    public static class EditorSimulateModeHelper
    {
        ...
        public static SimulateBuildResult SimulateBuild(string buildPipelineName, string packageName)
        {
            ...
            return (SimulateBuildResult)InvokePublicStaticMethod(_classType, "SimulateBuild", buildPipelineName,
                packageName);
        }
        ...
        private static object InvokePublicStaticMethod(Type type, string method, params object[] parameters)
        {
