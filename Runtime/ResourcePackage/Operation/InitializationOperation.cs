namespace YooAsset
{
    ...
    internal sealed class EditorSimulateModeInitializationOperation : InitializationOperation
    {
        ...
        internal EditorSimulateModeInitializationOperation(EditorSimulateModeImpl impl,
            EditorSimulateModeParameters parameters)
        {
            _impl = impl;
        ...
        internal override void InternalOnUpdate()
        {
            if (_steps == ESteps.CreateFileSystem)
            {
                ...
                _impl.EditorFileSystem =
                    PlayModeHelper.CreateFileSystem(_impl.PackageName, _parameters.EditorFileSystemParameters);
    ...
    internal sealed class OfflinePlayModeInitializationOperation : InitializationOperation
    {
        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.CreateFileSystem)
            {
                ...
                _impl.BuildinFileSystem =
                    PlayModeHelper.CreateFileSystem(_impl.PackageName, _parameters.BuildinFileSystemParameters);
    ...
    internal sealed class HostPlayModeInitializationOperation : InitializationOperation
    {
        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.CreateFileSystem)
            {
                ...
                {
                    _impl.DeliveryFileSystem =
                        PlayModeHelper.CreateFileSystem(_impl.PackageName, _parameters.DeliveryFileSystemParameters);
                ...
                _impl.CacheFileSystem =
                    PlayModeHelper.CreateFileSystem(_impl.PackageName, _parameters.CacheFileSystemParameters);
    ...
    internal sealed class WebPlayModeInitializationOperation : InitializationOperation
    {
        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.CreateFileSystem)
            {
                ...
                _impl.WebFileSystem =
                    PlayModeHelper.CreateFileSystem(_impl.PackageName, _parameters.WebFileSystemParameters);
