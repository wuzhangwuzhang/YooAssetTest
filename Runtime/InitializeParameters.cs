...
namespace YooAsset
{
    ...
    {
        internal Dictionary<string, object> CreateParameters = new();
        ...
        public static FileSystemParameters CreateDefaultEditorFileSystemParameters(
            SimulateBuildResult simulateBuildResult)
        {
        ...
        public static FileSystemParameters CreateDefaultBuildinFileSystemParameters(
            IDecryptionServices decryptionServices = null, EFileVerifyLevel verifyLevel = EFileVerifyLevel.Middle,
        ...
        /// <param name="verifyLevel">缓存文件的校验等级</param>
        /// <param name="rootDirectory">内置文件的根路径</param>
        public static FileSystemParameters CreateDefaultBuildinRawFileSystemParameters(
            IDecryptionServices decryptionServices = null, EFileVerifyLevel verifyLevel = EFileVerifyLevel.Middle,
            string rootDirectory = null)
        {
            var fileSystemClass = typeof(DefaultBuildinFileSystem).FullName;
        ...
        /// <param name="verifyLevel">缓存文件的校验等级</param>
        /// <param name="rootDirectory">文件系统的根目录</param>
        public static FileSystemParameters CreateDefaultCacheRawFileSystemParameters(IRemoteServices remoteServices,
            IDecryptionServices decryptionServices = null, EFileVerifyLevel verifyLevel = EFileVerifyLevel.Middle,
            string rootDirectory = null)
        {
            var fileSystemClass = typeof(DefaultCacheFileSystem).FullName;
