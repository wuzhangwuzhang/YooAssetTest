...
namespace YooAsset
{
    internal class DownloadPackageHashOperation : AsyncOperationBase
    {
        ...
        {
            _requestCount =
                WebRequestCounter.GetRequestFailedCount(_fileSystem.PackageName, nameof(DownloadPackageHashOperation));
        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.DownloadFile)
            {
                if (_webFileRequestOp == null)
                {
                    ...
                    var fileName =
                        YooAssetSettingsData.GetPackageHashFileName(_fileSystem.PackageName, _packageVersion);
                ...
                else
                {
                    ...
                    WebRequestCounter.RecordRequestFailed(_fileSystem.PackageName,
                        nameof(DownloadPackageHashOperation));
                }
            }
        }
