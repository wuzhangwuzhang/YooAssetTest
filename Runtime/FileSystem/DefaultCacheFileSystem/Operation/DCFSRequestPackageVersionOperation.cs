namespace YooAsset
{
    internal class DCFSRequestPackageVersionOperation : FSRequestPackageVersionOperation
    {
        ...
        internal DCFSRequestPackageVersionOperation(DefaultCacheFileSystem fileSystem, bool appendTimeTicks,
            int timeout)
        {
        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.GetPackageVersion)
            {
                ...
                {
                    _requestRemotePackageVersionOp =
                        new RequestRemotePackageVersionOperation(_fileSystem, _appendTimeTicks, _timeout);
