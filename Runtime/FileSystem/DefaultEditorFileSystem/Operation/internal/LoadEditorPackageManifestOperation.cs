...
namespace YooAsset
{
    internal class LoadEditorPackageManifestOperation : AsyncOperationBase
    {
        ...
        internal LoadEditorPackageManifestOperation(DefaultEditorFileSystem fileSystem, string packageVersion,
            string packageHash)
        {
        ...
        internal override void InternalOnUpdate()
        {
            ...
            {
                var manifestFilePath = _fileSystem.GetEditorPackageManifestFilePath(_packageVersion);
