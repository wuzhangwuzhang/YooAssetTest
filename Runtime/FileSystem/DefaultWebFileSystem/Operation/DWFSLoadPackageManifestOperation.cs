        ...
        internal override void InternalOnUpdate()
        {
            ...
            if (_steps == ESteps.RequestWebPackageHash)
            {
                if (_requestWebPackageHashOp == null)
                {
                    ...
                    _requestWebPackageHashOp =
                        new RequestWebPackageHashOperation(_fileSystem, packageVersion, _timeout);
            ...
            if (_steps == ESteps.LoadWebPackageManifest)
            {
                if (_loadWebPackageManifestOp == null)
                {
                    ...
                    _loadWebPackageManifestOp =
                        new LoadWebPackageManifestOperation(_fileSystem, packageVersion, packageHash);
