...
namespace YooAsset.Editor
{
    ...
    {
        private readonly List<ItemWrapper> _items = new();
        ...
        public void FillViewData(BuildReport buildReport)
        {
            ...
            _items.Add(new ItemWrapper("Encrypted Bundle Total Count",
                $"{buildReport.Summary.EncryptedBundleTotalCount}"));
            _items.Add(new ItemWrapper("Encrypted Bundle Total Size",
                ConvertSize(buildReport.Summary.EncryptedBundleTotalSize)));
