...
namespace YooAsset.Editor
{
    internal class ReporterBundleListViewer
    {
        ...
        {
            var result = new List<ReportBundleInfo>(_buildReport.BundleInfos.Count);
        ...
        private void BundleListView_onSelectionChange(IEnumerable<object> objs)
        {
            ...
            {
                var bundleInfo = item as ReportBundleInfo;
        ...
        private void ShowAssetBundleInspector(ReportBundleInfo bundleInfo)
        {
            ...
            var rootDirectory = Path.GetDirectoryName(_reportFilePath);
            var filePath = $"{rootDirectory}/{bundleInfo.FileName}";
        ...
        {
            var containsList = new List<ReportAssetInfo>();
            ...
            foreach (var assetPath in bundleInfo.AllBuiltinAssets)
        ...
        {
            var containsList = _includeListView.itemsSource as List<ReportAssetInfo>;
            var assetInfo = containsList[index];
