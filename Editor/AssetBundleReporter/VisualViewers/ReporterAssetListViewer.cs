...
namespace YooAsset.Editor
{
    internal class ReporterAssetListViewer
    {
        ...
        {
            var result = new List<ReportAssetInfo>(_buildReport.AssetInfos.Count);
        ...
        private void AssetListView_onSelectionChange(IEnumerable<object> objs)
        {
            ...
            {
                var assetInfo = item as ReportAssetInfo;
        ...
        {
            var bundles = new List<ReportBundleInfo>();
            var mainBundle = _buildReport.GetBundleInfo(assetInfo.MainBundleName);
            bundles.Add(mainBundle);
            foreach (var dependBundleName in mainBundle.DependBundles)
            {
        ...
        {
            var bundles = _dependListView.itemsSource as List<ReportBundleInfo>;
