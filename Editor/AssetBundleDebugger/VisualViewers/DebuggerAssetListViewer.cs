...
namespace YooAsset.Editor
{
    internal class DebuggerAssetListViewer
    {
        ...
        {
            var result = new List<DebugProviderInfo>(1000);
        ...
        private void BindAssetListViewItem(VisualElement element, int index)
        {
            ...
            label6.text = providerInfo.Status;
        ...
        private void AssetListView_onSelectionChange(IEnumerable<object> objs)
        {
            ...
            {
                var providerInfo = item as DebugProviderInfo;
        ...
        {
            var bundles = _dependListView.itemsSource as List<DebugBundleInfo>;
