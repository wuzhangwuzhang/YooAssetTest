...
namespace YooAsset.Editor
{
    [CreateAssetMenu(fileName = "AssetBundleCollectorSetting",
        menuName = "YooAsset/Create AssetBundle Collector Settings")]
    public class AssetBundleCollectorSetting : ScriptableObject
    {
        ...
        public CollectResult GetPackageAssets(EBuildMode buildMode, string packageName)
        {
            ...
            var command = new CollectCommand(buildMode, packageName,
            ...
            // 获取收集的资源集合
            var collectResult = new CollectResult(command);
