...
namespace YooAsset.Editor
{
    public static class AssetBundleBuilderSetting
    {
        ...
        {
            var key = $"{Application.productName}_{packageName}_{nameof(EBuildPipeline)}";
        ...
        {
            var key = $"{Application.productName}_{packageName}_{buildPipeline}_{nameof(EBuildMode)}";
        ...
        {
            var key = $"{Application.productName}_{packageName}_{buildPipeline}_{nameof(ECompressOption)}";
            return (ECompressOption)EditorPrefs.GetInt(key, (int)ECompressOption.LZ4);
        }

        public static void SetPackageCompressOption(string packageName, EBuildPipeline buildPipeline,
        ...
        {
            var key = $"{Application.productName}_{packageName}_{buildPipeline}_{nameof(EFileNameStyle)}";
            return (EFileNameStyle)EditorPrefs.GetInt(key, (int)EFileNameStyle.HashName);
        }

        public static void SetPackageFileNameStyle(string packageName, EBuildPipeline buildPipeline,
        ...
        public static EBuildinFileCopyOption GetPackageBuildinFileCopyOption(string packageName,
            EBuildPipeline buildPipeline)
        {
            var key = $"{Application.productName}_{packageName}_{buildPipeline}_{nameof(EBuildinFileCopyOption)}";
            return (EBuildinFileCopyOption)EditorPrefs.GetInt(key, (int)EBuildinFileCopyOption.None);
        }

        public static void SetPackageBuildinFileCopyOption(string packageName, EBuildPipeline buildPipeline,
        ...
        {
            var key = $"{Application.productName}_{packageName}_{buildPipeline}_BuildFileCopyParams";
            return EditorPrefs.GetString(key, string.Empty);
        }

        public static void SetPackageBuildinFileCopyParams(string packageName, EBuildPipeline buildPipeline,
        ...
        {
            var key = $"{Application.productName}_{packageName}_{buildPipeline}_EncyptionClassName";
            return EditorPrefs.GetString(key, string.Empty);
        }

        public static void SetPackageEncyptionClassName(string packageName, EBuildPipeline buildPipeline,
            string encyptionClassName)
        {
            var key = $"{Application.productName}_{packageName}_{buildPipeline}_EncyptionClassName";
