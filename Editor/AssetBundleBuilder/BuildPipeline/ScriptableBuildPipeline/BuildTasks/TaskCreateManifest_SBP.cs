...
namespace YooAsset.Editor
{
    ...
    {
        private TaskBuilding_SBP.BuildResultContext _buildResultContext;
        ...
        protected override string[] GetBundleDepends(BuildContext context, string bundleName)
        {
            ...
            {
                var message = BuildLogger.GetErrorMessage(ErrorCode.NotFoundUnityBundleInBuildResult,
                    $"Not found bundle in engine build result : {bundleName}");
